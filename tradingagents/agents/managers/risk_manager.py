...
def create_risk_manager(llm, memory):
    def risk_manager_node(state) -> dict:
        ...
        prompt = f"""As the Risk Management Judge and Debate Facilitator, your goal is to evaluate the debate between three risk analysts—Aggressive, Neutral, and Conservative—and determine the best course of action for the trader. Your decision must result in a clear recommendation: Buy or Sell. You are NOT ALLOWED to output Hold. Strive for clarity and decisiveness.
