...
def create_social_media_analyst(llm):
    def social_media_analyst_node(state):
        ...
        system_message = (
            ...
            "CRITICAL EXCEPTION: If the asset is 'GOLD', 'XAUUSD', or a major Forex pair, DO NOT treat it as a company stock ticker. Instead, search for macroeconomic news, commodities market sentiment, inflation data, and central bank policy discussions that impact the asset.\n"
